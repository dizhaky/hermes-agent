...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "platform.teams": ("microsoft-teams-apps==2.0.13.4", "aiohttp==3.14.3"),  # aiohttp >=3.14.1 (pinned 3.14.3): CVE-2026-34993(RCE)/47265 + 34513/34518/34519/34520/34525
    ...
    "terminal.modal": ("modal==1.3.4", "cbor2==6.1.3"),
