...
| `crm` | CLI command | Dex-style personal CRM: contacts, keep-in-touch cadences, interaction timeline, due board, birthdays, and a cron-ready daily digest (`hermes crm ...`) |
